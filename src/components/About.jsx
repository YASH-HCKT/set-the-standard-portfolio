            ...
            <div className="flex flex-col lg:flex-row gap-16 items-start">
                <div className="flex-1 space-y-8 min-w-0">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="p-8 md:p-16 rounded-[3rem] bg-gradient-to-br from-violet-500/10 via-transparent to-transparent border border-border relative group shadow-2xl shadow-transparent hover:shadow-violet-500/5 transition-all duration-700"
                    >
                        <div className="absolute top-0 right-0 p-12 opacity-[0.03] group-hover:opacity-[0.07] group-hover:-rotate-12 transition-all duration-1000">
                            <User className="w-64 h-64" />
                        </div>
                        <h3 className="text-3xl font-black text-foreground mb-8 tracking-tight">Building Digital Experiences</h3>
                        <p className="text-xl text-muted/90 leading-relaxed font-medium">
